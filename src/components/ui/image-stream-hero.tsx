/* Ported from the supplied file. Two edits: the Next.js "use client"
 * directive is removed (a Vite SPA — every component is a client
 * component), and `stageClassName` is added so a layout can place the
 * corridor layer itself (the phone hero puts it in the flow as a band
 * under the copy). The corridor math is untouched. */
...
export type ImageStreamHeroProps = {
  ...
  /** Extra class on the corridor layer (by default absolute, filling the root). */
